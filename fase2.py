...
def mesMaisChuvoso():
    ...
    for mes in range(1,8): #colocado 8 (julho) por que os dados em 2016 vão até julho
...
#     dicionario[soma] = nova   
       
#     for soma,nova in sorted(dicionario.items()):
#         print(f"\nO mês de {nova[1]} de {nova[0]} possui o maior valor acumulado de chuva no período avaliado, totalizando {soma:.3f} mm/m²\n")
#         break      
# # return
...
def decadaMaisChuvosa():
    ...
    print("A precipitação acumulada nas décadas ", decadas, " foi, respectivamente: \n", precipitacao, "\n")

 #>>>>>>>>> Gráfico

    plt.bar(decadas, precipitacao) # plota o gráfico de barras
    plt.title("Precipitação acumulada (mm/m²) da década de 1960 a década de 2010") # título do gráfico
    plt.xlabel("Décadas") # legenda eixo x
    plt.ylabel("Acumulado de chuva (mm/m²)") # legenda eixo y
...
try:
    ...
    print("\n---- DÉCADA COM MAIOR VALOR ACUMULADO DE CHUVA DO PERÍODO ---- \n")
    decadaMaisChuvosa()
